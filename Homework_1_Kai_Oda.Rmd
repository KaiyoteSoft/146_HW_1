...
Similarily, increasing the sample size results in a SD closer to the actual value. However, increasing the sample size does not change the actual value of the mean or standard deviation.
...
ggplot(endangered, aes(x=taxon, y=no.species))+
  geom_col(color=endangered$vertebrate, 
           fill=ifelse(endangered$vertebrate=="yes", "red", "black"))+
